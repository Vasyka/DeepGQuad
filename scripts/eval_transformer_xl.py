...
from transformer-xl.mem_transformer import MemTransformerLM
from transformer-xl.utils.dna_functions import Logger, FocalLoss
import transformer-xl.utils.proj_adaptive_softmax
from transformer-xl.data_utils import get_lm_corpus
...
print(input_args)
with open(input_args.model_path, 'r', encoding='utf-8') as fh:
