...
# Generate shuffled (fix on chromosome, exclude quadruplexes)
bedtools shuffle -i G4_chip_centered.bed -g hg19.chrom.sizes -chrom -excl G4_chip_centered.bed -seed 42 > shuffled_full.bed
